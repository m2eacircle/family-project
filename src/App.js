...
import { Clock, BookOpen, Trophy, BarChart3, CheckCircle, XCircle, Home, Play, ArrowLeft, ChevronRight, Download, Flag, Eye, TrendingUp, Pause } from 'lucide-react';
...
const questionBank = {
  "Inflammation and Healing": [
    ...
    { id: 121, question: "The main complication of chronic inflammation emphasized by the professor is:", options: ["Edema", "Deep ulceration", "Keloid formation", "Bone fracture"], correct: 1 },
  ...
  "Immunity and Infection (Part 1)": [
    ...
    { id: 219, question: "Which of the following is a component AND an element of the immune system (in both lists)?", options: ["Antigen", "Complement", "Lymphocytes", "Antibodies"], correct: 2 },
    ...
    { id: 243, question: "Which of the following is NOT a protein?", options: ["Histamine", "Cytokines", "Prostaglandin", "Dopamine"], correct: 0 },
    ...
    { id: 250, question: "Which drug name do you specifically need to know for the exam as an immunosuppressant in transplant rejection?", options: ["Prednisone", "Azathioprine", "Cyclosporine", "Methotrexate"], correct: 2 },
    ...
    { id: 267, question: "The only immunosuppressant required for exam:", options: ["Prednisone", "Methotrexate", "Cyclosporine", "Azathioprine"], correct: 2 },
    ...
    { id: 280, question: "In Type III hypersensitivity, the red circles in the diagram represent:", options: ["Antibodies", "Antigens", "T-cells", "Histamine granules"], correct: 1 },
    ...
    { id: 296, question: "The MOST important step for the exam in HIV's life cycle is:", options: ["Viral budding", "Capsid formation", "Spike protein synthesis", "Integration of viral DNA into human chromosome"], correct: 3 },
    ...
    { id: 299, question: "In the HIV progression graph, the red curve represents:", options: ["CD4 cells", "Antibodies", "Viral load", "T-cell memory"], correct: 2 },
    ...
    { id: 301, question: "The infection shown as Picture A (PCP) is most commonly associated with:", options: ["Healthy young adults", "HIV/AIDS patients", "Childhood viral infections", "Autoimmune disease"], correct: 1 },
    ...
    { id: 303, question: "Kaposi sarcoma (Picture B) is caused by which virus?", options: ["HIV", "HPV", "HHV-8", "EBV"], correct: 2 },
    ...
    { id: 305, question: "Picture C shows severe esophageal bleeding caused by:", options: ["Streptococcus", "Candida infection", "CMV", "HSV"], correct: 1 },
    ...
    { id: 307, question: "Picture D shows aggressive periodontitis commonly associated with:", options: ["HIV infection", "Influenza", "Allergies", "Appendicitis"], correct: 0 },
  ...
  "Immunity and Infection (Part 2)": [
    ...
    { id: 227, question: "The two major classes of WBCs mentioned by the professor are:", options: ["B cells and T cells", "NK cells and T cells", "Granulocytes and agranulocytes", "Dendritic cells and macrophages"], correct: 2 },
  ...
  "Stress and Associated Problems": [
    ...
    { id: 523, question: "Which is a specific problem of chronic stress mentioned by the professor?", options: ["Chronic back pain", "Necrotizing periodontal disease", "Frequent urination", "Weight gain"], correct: 1 },
    ...
    { id: 594, question: "Which of the following is NOT one of the 5 significant effects of the stress response listed by the professor?", options: ["Increased blood pressure and heart rate", "Bronchodilation and increased ventilation", "Increased blood glucose level", "Increased inflammatory response"], correct: 3 },
    ...
    { id: 600, question: "Which chronic conditions did the professor mention as being worsened by stress? (Choose the BEST combination.)", options: ["Diabetes only", "Asthma and common cold only", "Multiple sclerosis, rheumatoid arthritis, systemic lupus erythematosus, eczema, ulcerative colitis", "Migraine only"], correct: 2 },
  ...
  "Blood and Circulatory System Disorders": [
    ...
    { id: 682, question: "According to the lecture, which TWO leukocytes are specifically mentioned as being able to perform diapedesis (exit the bloodstream and go to tissues)?", options: ["Neutrophils and eosinophils", "Basophils and monocytes", "Lymphocytes and monocytes", "Eosinophils and lymphocytes"], correct: 1 },
    ...
    { id: 705, question: "Which of the following is NOT a typical etiology of iron deficiency anemia mentioned in the lecture?", options: ["Insufficient iron intake or absorption", "Chronic blood loss", "Acute liver disease", "Genetic mutation of hemoglobin (like sickle cell disease)"], correct: 3 },
    { id: 706, question: "Which symptoms did the professor highlight as especially important for IDA (iron deficiency anemia)?", options: ["Muscle cramps and seizures", "Stomatitis, glossitis, and menstrual irregularities", "Hearing loss and tinnitus", "Night blindness and dry skin"], correct: 1 },
    ...
    { id: 712, question: "Which of the following is NOT listed as a cause (etiology) of pernicious anemia in the lecture?", options: ["Genetic factors", "Malabsorption of vitamin B12", "Gastrectomy (removal of part of the stomach)", "Acute trauma to long bones"], correct: 3 },
    ...
    { id: 714, question: "Which symptoms did the professor specifically highlight for pernicious anemia?", options: ["Leg cramps, dry skin, blurred vision", "Glossitis, paresthesia, and digestive discomfort", "Severe bruising and nosebleeds", "Night blindness and hair loss"], correct: 1 },
    ...
    { id: 718, question: "In aplastic anemia, the professor emphasized two key laboratory findings:", options: ["Leukocytosis and thrombocytosis", "Leukopenia and thrombocytopenia", "High hemoglobin and high RBC count", "Increased neutrophils and eosinophils"], correct: 1 },
    ...
    { id: 725, question: "What does \"diploid\" mean, as explained in the lecture?", options: ["Having only one copy of each gene", "Having two sets of chromosomes, thus two copies (alleles) of each gene", "Having three copies of each gene", "Having no chromosomes"], correct: 1 },
    { id: 726, question: "In the simplified notation used in the textbook and lecture, the genotype AA represents:", options: ["A person with sickle cell disease", "A carrier (trait)", "A healthy person with normal hemoglobin", "A person with thalassemia"], correct: 2 },
    ...
    { id: 733, question: "A person with genotype AA for the sickle cell gene (using the simplified notation from the lecture) is:", options: ["Diseased (sickle cell anemia)", "Carrier (trait)", "Healthy", "Unable to produce hemoglobin"], correct: 2 },
    ...
    { id: 739, question: "In the example from the lecture, what is the probability of a child with sickle cell anemia if both parents are carriers (AS × AS)?", options: ["0%", "25%", "50%", "75%"], correct: 1 },
    { id: 740, question: "Which of the following is a major complication of sickle cell anemia, as described in the lecture?", options: ["RBCs become smaller and very flexible", "RBCs become sickle-shaped, get stuck in vessels, causing thrombosis and necrosis", "Platelets disappear completely", "Plasma volume is zero"], correct: 1 },
    { id: 741, question: "Which symptom is particularly associated with sickle cell anemia in the lecture?", options: ["Hyperbilirubinemia and jaundice", "Only headache", "Only hypertension", "Only night blindness"], correct: 0 },
    ...
    { id: 745, question: "Which genotypes are possible in females for hemophilia A, using the notation in lecture?", options: ["XᴴY and XʰY", "XᴴXᴴ, XᴴXʰ, and XʰXʰ", "Only XʰXʰ", "Only XᴴXᴴ"], correct: 1 },
    ...
    { id: 747, question: "In the lecture example, a diseased man (XʰY) marries a trait woman (XᴴXʰ). What is the probability that their daughters (girls) have hemophilia A?", options: ["0%", "25% of all daughters (50% of daughters)", "50% of all children", "100% of daughters"], correct: 1 },
    ...
    { id: 754, question: "Which of the following is TRUE about chronic leukemia according to the lecture?", options: ["It produces immature cells and usually affects children", "It produces mature cells and usually affects older people", "It only affects platelets", "It is always caused by vitamin deficiency"], correct: 1 },
    { id: 755, question: "Common symptoms of leukemia mentioned in the lecture include:", options: ["Severe hemorrhage, bone pain, weight loss, splenomegaly and hepatomegaly", "Only fever and cough", "Only nausea and vomiting", "Only hair loss"], correct: 0 },
